...
//  DesignCode
//
//  Created by Martin Chibwe on 5/27/21.
//
...
//                        .repeatCount(3, autoreverses: false)
            ...
            BackCardView()
                .frame(width: showCard  ? CGFloat(300) : 340, height: 220, alignment: /*@START_MENU_TOKEN@*/.center/*@END_MENU_TOKEN@*/)
                ...
                .gesture(
                    DragGesture()
                        ...
                        .onEnded{ value in
                            ...
                            if (self.bottomState.height < -100 && !self.show) || (self.bottomState.height < -250 && self.showFull){
                                self.bottomState.height = -300
                                self.showFull = true
                            }else {
